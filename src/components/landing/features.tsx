...
export default function Features() {
    ...
    return (
        <>
            <div className="px-6 md:px-48 py-24 flex flex-col gap-24 items-center justify-center">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="font-poppins text-base px-0 md:px-48 text-neutral-400 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 justify-between w-full items-center gap-12">
