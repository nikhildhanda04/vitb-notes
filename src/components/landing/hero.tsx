    ...
    return (
        <>
            <div className="relative overflow-hidden flex flex-col items-center px-52 gap-16 h-screen -mt-24 justify-center">
                {/* Glow Effects */}
                <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-white/4 blur-[120px] rounded-full pointer-events-none mix-blend-screen" />
                <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-zinc-500/4 blur-[120px] rounded-full pointer-events-none mix-blend-screen" />
