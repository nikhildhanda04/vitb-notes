...
export function NoteCard({ note }: NoteCardProps) {
    return (
        <div className="group flex flex-col p-6 bg-white dark:bg-neutral-900 rounded-md border border-zinc-200 dark:border-zinc-700 shadow-[6px_6px_0px_0px_#737373] hover:shadow-[8px_8px_0px_0px_#737373] transition-all duration-300 h-full relative overflow-hidden">
            {/* Content */}
